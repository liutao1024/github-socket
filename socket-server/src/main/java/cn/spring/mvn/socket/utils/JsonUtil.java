...
public class JsonUtil {
    ...
    public static void main(String[] args) {
        ...
        String json = FileUtils.readToString(new File(
                "E:\\Tortoise\\GitHub\\github-socket\\socket-server\\src\\main\\resources\\interface\\json\\opcust.json"), "UTF-8");
        parseJson2Java(json);
    }
    ...
    public static void parseJson2Java(String jsonStr) {
        ...
        FileUtils.writeString2File(javaBeanStr, new File(
                "E:\\Tortoise\\GitHub\\github-socket\\socket-server\\src\\main\\resources\\interface\\json\\OpcustBean.java"));
    }
